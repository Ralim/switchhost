...
// TermUIWriter parses the JSON input and writes it in an
// (optionally) colorized, human-friendly format to Out.
type TermUIWriter struct {
...
// NewTermUIWriter creates and initializes a new TermUIWriter.
func NewTermUIWriter(options ...func(w *TermUIWriter)) TermUIWriter {
	w := TermUIWriter{
		Out:        os.Stdout,
...
func (w TermUIWriter) Write(p []byte) (n int, err error) {
	if w.PartsOrder == nil {
...
func (w TermUIWriter) writeFields(evt map[string]interface{}, buf *bytes.Buffer) {
...
func (w TermUIWriter) writePart(buf *bytes.Buffer, evt map[string]interface{}, p string) {
	var f Formatter
...
// colorize returns the string s wrapped in TermUI colours
func colorize(s interface{}, c int, disabled bool) string {
	...
	return fmt.Sprintf("%s%v[-:-:-]", colText, s) // dashes are resets
}
